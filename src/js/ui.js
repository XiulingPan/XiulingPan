...
function toggleLoading(isLoading) {
  ...
  if(isLoading){
    document.getElementById("searchBtn").classList.replace("fa-search","fa-hourglass-half");
    document.getElementById("searchBtn").innerHTML = " Loading...";
    document.getElementById("searchBtn").disabled = true;
  }else{
    document.getElementById("searchBtn").classList.replace("fa-hourglass-half","fa-search");
